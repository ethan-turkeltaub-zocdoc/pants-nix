...
#   python -m gen tag 2.24.1
let
  lib = import ../../common/lib.nix;

  version = "2.24.1";
  hash = "sha256-zHCet9/f19UZOFXasq4DNJN9a4Kg9Ty5nlgenk1bvhE=";

  # https://raw.githubusercontent.com/pantsbuild/pants/release_2.24.1/src/rust/engine/rust-toolchain
  rustVersion = "1.82.0";
  cargoLock = {
    # https://raw.githubusercontent.com/pantsbuild/pants/release_2.24.1/src/rust/engine/Cargo.lock
    lockFile = ./Cargo.lock;
    outputHashes = {
